...
public class GutterClickAction extends AnAction {
  private final f a;
  
  public GutterClickAction(f documentLine) {
    this.a = documentLine;
  }
  ...
  public final void actionPerformed(AnActionEvent e) {
    ...
    if (b == null)
      return; 
    String str = b.d();
    wallabyController.f(str, this.a.k());
    wallabyController.a(str, this.a.k(), editor, e);
  }
}


/* Location:              /Users/fdhuang/works/idea/code/libs/wallaby-intellij.jar!/com/wallaby/javascript/actions/GutterClickAction.class
