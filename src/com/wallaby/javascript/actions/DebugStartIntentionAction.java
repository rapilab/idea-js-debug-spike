...
public class DebugStartIntentionAction extends h {
  ...
  public static boolean a(m paramm, b paramb, int paramInt) {
    ...
    return (f == null) ? false : ((f.a() == CoverageState.NOT_COVERED) ? false : ((paramm.R() && paramm.y())));
  }
  ...
  protected void a(m paramm, Editor paramEditor, b paramb, String paramString, int paramInt) {
    ...
    if (f.a() == CoverageState.NOT_COVERED)
      return; 
    paramm.a(paramEditor, paramString, f.k(), null);
  }
}


/* Location:              /Users/fdhuang/works/idea/code/libs/wallaby-intellij.jar!/com/wallaby/javascript/actions/DebugStartIntentionAction.class
