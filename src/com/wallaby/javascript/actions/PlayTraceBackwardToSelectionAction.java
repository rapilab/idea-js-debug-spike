...
public class PlayTraceBackwardToSelectionAction extends WallabyControllerAction {
  public PlayTraceBackwardToSelectionAction() {
    Presentation presentation = getTemplatePresentation();
    presentation.setIcon(a.g);
  }
  ...
  protected void a(AnActionEvent paramAnActionEvent, m paramm) {
    ...
    if (virtualFile instanceof o) {
      ...
      if (originalLineData == null || originalLineData.c() == null)
        return; 
      paramm.a(originalLineData.a(), originalLineData.b() + 1, originalLineData.c());
    } else {
      b b = paramm.a(editor);
      if (b == null)
        return; 
  ...
  protected boolean b(AnActionEvent paramAnActionEvent, m paramm) {
    ...
    if (b == null)
      return false; 
    f f = b.a(editor.getCaretModel().getOffset());
    return (f == null) ? false : ((f.a() == CoverageState.NOT_COVERED) ? false : paramm.B());
  }
}


/* Location:              /Users/fdhuang/works/idea/code/libs/wallaby-intellij.jar!/com/wallaby/javascript/actions/PlayTraceBackwardToSelectionAction.class
